...
<body class="bg-default">
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-gradient-primary py-7 py-lg-8" style="height: 30rem">
    ...
    <div class="container pb-5" style="margin-top: -22rem">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-6" style="margin: auto">
          ...
          <p class="text-lead text-light">Aplikasi membantu Anda terhubung dan berbagi dengan orang-orang dalam kehidupan Anda.</p>
        </div>
